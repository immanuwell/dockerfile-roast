...
#
# Usage:
#   ./scripts/publish-vscode.sh 1.4.2              # publish to Marketplace
#   ./scripts/publish-vscode.sh 1.4.2 --dry-run    # package only, no publish
#
# Requirements:
...
if [[ -z "$VERSION" ]]; then
    echo "Usage: $0 <version> [--dry-run]  (e.g. $0 1.4.2)" >&2
    exit 1
fi
